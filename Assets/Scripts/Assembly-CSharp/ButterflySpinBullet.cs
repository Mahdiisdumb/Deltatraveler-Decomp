...
public class ButterflySpinBullet : BulletBase
{
	...
	private void Update()
	{
		...
		float num2 = 1f + Mathf.Sin((float)(270 + frames * 3) * (MathF.PI / 180f)) * 0.125f;
		base.transform.position = center + new Vector3(Mathf.Sin(num * (MathF.PI / 180f)), 0f - Mathf.Cos(num * (MathF.PI / 180f))) * num2;
