...
public class UIBackground : MonoBehaviour
{
	...
	public void CreateElement()
	{
		...
		if (ts || bnp)
		{
			...
			obj4.transform.SetParent(base.transform, false);
		...
		else
		{
			...
			border.transform.SetParent(base.transform, false);
		...
		box.transform.SetParent(base.transform, false);
		...
		if (bnp)
		{
			...
			for (int i = 0; i < 4; i++)
			{
				...
				obj5.transform.SetParent(base.transform, false);
		...
		else if (ts)
		{
			...
			for (int j = 0; j < 4; j++)
			{
				...
				obj6.transform.SetParent(base.transform, false);
