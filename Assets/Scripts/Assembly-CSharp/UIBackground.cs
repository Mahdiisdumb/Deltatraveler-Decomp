...
public class UIBackground : MonoBehaviour
{
	...
	private void Awake()
	{
		...
		frosted = SceneManager.GetActiveScene().buildIndex == 123;
	}
	...
	public void CreateElement()
	{
		...
		if (ts || frosted)
		{
			if (ts)
			{
				GameObject obj = new GameObject(objName + "BorderHori", typeof(RectTransform), typeof(Image));
				obj.transform.SetParent(base.transform, worldPositionStays: false);
				obj.transform.localPosition = pos;
				obj.transform.GetComponent<RectTransform>().sizeDelta = new Vector2(size.x, size.y - 16f);
				obj.GetComponent<Image>().color = Color.black;
				GameObject obj2 = new GameObject(objName + "BorderVert", typeof(RectTransform), typeof(Image));
				obj2.transform.SetParent(base.transform, worldPositionStays: false);
				obj2.transform.localPosition = pos;
				obj2.transform.GetComponent<RectTransform>().sizeDelta = new Vector2(size.x - 16f, size.y);
				...
				obj3.transform.GetComponent<RectTransform>().sizeDelta = new Vector2(size.x, size.y - 16f);
				...
				obj4.transform.GetComponent<RectTransform>().sizeDelta = new Vector2(size.x - 16f, size.y);
				obj4.GetComponent<Image>().color = borderColors[(int)Util.GameManager().GetFlag(223)];
			}
			else
			{
				GameObject obj5 = new GameObject(objName + "BorderOuter", typeof(RectTransform), typeof(Image));
				obj5.transform.SetParent(base.transform, worldPositionStays: false);
				obj5.transform.localPosition = pos;
				obj5.transform.GetComponent<RectTransform>().sizeDelta = new Vector2(size.x + 4f, size.y + 4f);
				obj5.GetComponent<Image>().color = Color.black;
				GameObject obj6 = new GameObject(objName + "BorderInner", typeof(RectTransform), typeof(Image));
				obj6.transform.SetParent(base.transform, worldPositionStays: false);
				obj6.transform.localPosition = pos;
				obj6.transform.GetComponent<RectTransform>().sizeDelta = new Vector2(size.x - 4f, size.y - 4f);
		...
		if (ts)
		{
			...
			{
				float z = 90 * i;
				GameObject obj7 = new GameObject(objName + "BorderCorner" + i, typeof(RectTransform), typeof(Image));
				obj7.GetComponent<Image>().sprite = sprite;
				obj7.GetComponent<RectTransform>().sizeDelta = new Vector2(16f, 16f);
				obj7.transform.SetParent(base.transform, worldPositionStays: false);
				obj7.transform.localPosition = pos + array[i];
				obj7.transform.eulerAngles = new Vector3(0f, 0f, z);
				obj7.GetComponent<Image>().color = borderColors[(int)Util.GameManager().GetFlag(223)];
			}
		}
