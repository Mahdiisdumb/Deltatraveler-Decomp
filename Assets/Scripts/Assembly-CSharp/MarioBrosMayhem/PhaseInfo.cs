...
namespace MarioBrosMayhem
{
	public class PhaseInfo
	{
		...
		public static Phase GetPhase(int i)
		{
			...
			{
				new Phase(PHASES[10].GetEnemies(), 5f, 52f, 4, 3, true, 1, true),
				new Phase(PHASES[11].GetEnemies(), 5f, 52f, 4, 3, true, 1, true),
				new Phase(PHASES[9].GetEnemies(), 5f, 52f, 4, 3, true, 1, true),
				new Phase(PHASES[10].GetEnemies(), 5f, 52f, 4, 3, true, 1, true),
				new Phase(PHASES[11].GetEnemies(), 5f, 52f, 4, 3, true, 1, true),
				new Phase(true, 3),
				new Phase(PHASES[9].GetEnemies(), 5f, 52f, 4, 3, true, 1, true)
