...
public class SusieLDRudeBusterHit : BulletBase
{
	...
	private void Update()
	{
		...
		velocity *= decayRate;
		base.transform.position += new Vector3(Mathf.Cos(base.transform.eulerAngles.z * (MathF.PI / 180f)), Mathf.Sin(base.transform.eulerAngles.z * (MathF.PI / 180f))) * velocity / 48f;
